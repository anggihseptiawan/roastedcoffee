          ...
          >
            <Box maxW={{ sm: '100%', md: '50%' }} position="relative" zIndex="2">
              ...
              <Text color="whiteAlpha.800" fontWeight="medium">
                Start your mornings with the worlds best coffees. Try our expertly curated artisan coffees from ours
      ...
      <main>
        <Container maxW="container.lg" py={['10', '20']}>
          ...
          <SimpleGrid columns={[2, 3, 4]} spacing={[5, 10]}>
            <Box>
              <Image borderRadius="md" src="/assets/images/sample 1.jpg" alt="coffee 1" />
              <Text fontWeight="bold" align="center" mt="4" mb="3" fontSize="18">
                Gran expresso
              </Text>
              <Text align="center">Light and flavorful blend with cocoa and black paper for an intense experinece</Text>
            </Box>
            <Box>
              <Image borderRadius="md" src="/assets/images/sample 2.jpg" alt="coffee 2" />
              <Text fontWeight="bold" align="center" mt="4" mb="3" fontSize="18">
                Planalto
              </Text>
              <Text align="center">Brazilian dark roast with rich and velvety body, and hints of fruit and nuts</Text>
            </Box>
            <Box>
              <Image
                borderRadius="md"
              ...
              <Text align="center">Mild and smooth blend featuring notes of toasted almond and dried cherry</Text>
            </Box>
            <Box>
              <Image borderRadius="md" src="/assets/images/sample 4.jpg" alt="coffee 4" />
              <Text fontWeight="bold" align="center" mt="4" mb="3" fontSize="18">
                Danche
              </Text>
              <Text align="center">Ethipiant hand-harvested blend densely packed with vibrant fruit notes</Text>
            </Box>
          </SimpleGrid>
          ...
          >
            <Box w={['90%', '50%']}>
              ...
              <Text align="center" color="whiteAlpha.800">
                A large part of our rule is choosing which particular coffees will be featured in our range. This means
          ...
          <SimpleGrid columns={[1, 2, 3]} spacing="5" px="10" mt="-95px">
            <Box background="teal.500" borderRadius="5" px="5" py="8">
              <Image
                ...
                height="40px"
              />
              <Heading as="h5" color="white" fontSize="lg" textAlign="center" mb="4">
                Best Quality
              </Heading>
            ...
            <Box background="teal.500" borderRadius="5" px="5" py="8">
              ...
              <Text color="whiteAlpha.800" align="center">
                Special offers and swag when you subscribe, including 30% of your first shipment.
              </Text>
            </Box>
            <Box background="teal.500" borderRadius="5" px="5" py="8">
              <Image
              ...
              <Text color="whiteAlpha.800" align="center">
                We cover the cost and coffee is delivered fast. Peak freshness guaranted.
              </Text>
            </Box>
          </SimpleGrid>
              ...
              <SimpleGrid columns={[1, 2, 3]} spacing="10">
                ...
                <Box>
                  ...
                  <Text>
                    ...
                    cancel your subscription with no commitment through our pipeline portal.
                  </Text>
                </Box>
                <Box>
                  <Heading fontSize="4xl" mb={['2', '10']} color="red.200">
