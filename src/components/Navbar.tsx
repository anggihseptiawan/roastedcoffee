    ...
    <>
        ...
        {page !== 'plan' && (
          <>
            <HStack spacing="15px" d={['none', 'flex']}>
              ...
              <Link href="#why" fontSize="12px" fontWeight="bold" color="gray.500">
                ABOUT US
              </Link>
              <Link href="#plan" fontSize="12px" fontWeight="bold" color="gray.500">
                CREATE YOUR PLAN
              </Link>
            </HStack>
      ...
      <Drawer isOpen={isOpen} placement="right" onClose={onClose} finalFocusRef={btnRef}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Stack spacing="5">
              <Link href="#home" fontSize="12px" fontWeight="medium" color="gray.500">
                HOME
              </Link>
              <Link href="#why" fontSize="12px" fontWeight="medium" color="gray.500">
                ABOUT US
              </Link>
              <Link href="#plan" fontSize="12px" fontWeight="medium" color="gray.500">
                CREATE YOUR PLAN
              </Link>
            </Stack>
          </DrawerBody>
